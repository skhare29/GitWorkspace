package com.sau.algorithims.sort;

public class BubbleSelectionInsertionSortDemo {
	...
	public static void main(String[] args) {
		...
		BubbleSelectionInsertionSortDemo newArray = new BubbleSelectionInsertionSortDemo();
