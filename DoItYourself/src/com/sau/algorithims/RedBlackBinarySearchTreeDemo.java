...
/*
TreeMap sorts the key objects using Red-Black tree algorithm. 
A Red-Black tree is a complex algorithm. 
It is a special type of binary search tree with each node having extra information about its color. 
Shown below are the properties of a Red-Black tree.
...
public class RedBlackBinarySearchTreeDemo {
